angular.module('todo', ['ionic','firebase'])
    ...
    .factory('Projects', function() {
      ...
      .controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
            ...
            $scope.projectsList = $firebase(new Firebase("https://blistering-torch-8190.firebaseio.com/projects")).$asObject();
            $scope.user = $firebase(new Firebase("https://blistering-torch-8190.firebaseio.com/Users/John")).$asObject();
